          ...
          >
            <template v-if="item.active">
              <img
                ...
                src="@/assets/images/drag_delete_icon.png"
              ...
              <img
                ...
                src="@/assets/images/drag_plus_icon.svg"
              ...
              >
                <img src="@/assets/images/drag_resize_icon.png" alt="" />
              </div>
              <img
                @mousedown.stop="
                  (event) => {
                ...
                "
                src="@/assets/images/drag_rotate_icon.svg"
